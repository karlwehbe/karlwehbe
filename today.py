...
USER_NAME = os.environ['USER_NAME'] # 'karlwehbe'
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    `length` is dots + value width so spacing stays aligned with the SVG layout.
    """
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 11, 4))
